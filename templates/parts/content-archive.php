<div class="helppress__container">
	...
	<div class="helppress__archive helppress__archive--<?php echo esc_attr( helppress_get_option( 'columns' ) ); ?>">
		<?php foreach ( helppress_get_categories() as $category ) : ?>
			<div class="helppress__archive-cat">
				<h2 class="helppress__archive-cat-title"><?php echo $category->name; ?></h2>

				<?php if ( $category->description ) : ?>
					<p class="helppress__archive-cat-description"><?php echo $category->description; ?></p>
				<?php endif; ?>
				...
				<ul class="helppress__article-list">
					...
					<?php foreach ( $articles as $article_id ) : ?>
						...
						<li class="helppress__article-list-item"><a href="<?php echo $permalink; ?>"><?php echo $icon . $title ?></a></li>
					<?php endforeach; ?>
				</ul>
